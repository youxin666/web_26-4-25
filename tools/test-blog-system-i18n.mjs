...
assert.match(worker, /script\.js\?v=20260904-thumbnail-drag-only/, 'the current production script needs a fresh cache key');
assert.match(worker, /styles\.css\?v=20260904-thumbnail-drag-only/, 'the current production stylesheet needs a fresh cache key');
