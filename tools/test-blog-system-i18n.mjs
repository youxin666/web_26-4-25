...
assert.match(worker, /script\.js\?v=20260904-horizontal-slide-arc/, 'the current production script needs a fresh cache key');
assert.match(worker, /styles\.css\?v=20260904-horizontal-slide-arc/, 'the current production stylesheet needs a fresh cache key');
