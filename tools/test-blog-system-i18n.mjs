...
assert.match(worker, /script\.js\?v=20260901-vertical-semicircle/, 'the current production script needs a fresh cache key');
assert.match(worker, /styles\.css\?v=20260901-vertical-semicircle/, 'the current production stylesheet needs a fresh cache key');
